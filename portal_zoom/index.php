...
<body>
	<form style="background-color: darkblue; height: 80px; padding-top: 10px;" action="login_check.php" method="POST">
		<div style="padding: 10px; width: 450px; display: inline-flex; ">
			<b style="font-family: cursive; font-size: 35px; color: #ed854d; margin-left: 75px;">Zoom Portal</b>
		</div>
	...
	<footer style="background-color: gray; height: 65px;">
		<div style="padding-top: 10px; padding-left: 25px;">&copy; 2024 zoom Portal</div>
		<div style="padding-bottom: 15px; padding-left: 25px;">Powred by saiku coder &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; This web application is best view in Firefox Quantum 62.0 and Chrome.</div>
	</footer>
